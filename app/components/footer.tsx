...
export const Footer = () => {
    ...
    return (
        <footer className="bg-second h-20 flex justify-center gap-10 items-center mt-30 max-md:h-full max-md:flex-col max-md:text-center max-md:p-10 text-background">
